...
namespace Elsnertech\ProductAttachment\Model\Config;
...
class ModuleMetadata implements ModuleMetadataInterface
{
    ...
    const PRODUCT_NAME = 'Product Attachment';

    const PRODUCT_URL = 'https://www.elsnertech.com/';

    const MODULE_NAME = 'Elsnertech_ProductAttachment';

    const VERSION_CACHE_KEY = 'elsnertech-productattachment-module-version';
